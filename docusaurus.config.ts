...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: "opentofu-ga",
      content:
        '<a href="/blog/help-us-test-opentofu-1-10-0-alpha1/" class="announcement-bar-link"><div class="announcement-bar-content">🚀 OpenTofu 1.10.0-alpha1 is released! <span class="announcement-arrow">→</span></div></a>',
